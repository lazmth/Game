...
public class WaterFrameBuffers {
	...
	private int createTextureAttachment( int width, int height) {
		...
		// Adds the texture attachment to the currently bound frame buffer object.
		// Setting it to colour attachement 0.
		// Last parameter is for which mipmap level we want to use. We haven't generated any
		// mipmaps here so we just use 0.
